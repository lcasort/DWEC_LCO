...
// Añadimos los valores por defecto a los campos.
document.querySelector("#nombre").value = localStorage.getItem('nombre');
document.querySelector("#apellidos").value = localStorage.getItem('apellidos');
document.querySelector("#email").value = localStorage.getItem('email');
document.querySelector("#telefono").value = localStorage.getItem('telefono');
document.querySelector("#nif").value = localStorage.getItem('nif');
...
async function enviarFormulario(formulario)
{
    ...
    const resp = await Controlador.editarCliente(cliente);
